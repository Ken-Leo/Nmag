...
class BoundVoronoi:
    def __init__(self, bound=(-20, 20, -20, 20), space=0.1):
    ...
    def _read_poisson(self, file_name='Poisson/Poisson/Poisson.txt'):
        position_list = []
    ...
    def generate(self):
        ...
        sp.spatial.voronoi_plot_2d(vor) # generate a T-D Voronoi plot
        # plt.show()
        ...
        # paint vertice_list
        fig = plt.figure()       # create a figure instance to prepare
        ax = fig.gca()           # get the current axes
        plt.axis(self._bounds)   # plot the axes
        # vertice_list
